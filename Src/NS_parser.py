...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument("--seed", default=42, help="seed for variance testing", type=int)
    ...
    def Env_n_Agent_args(self, parser):
        ...
        #parser.add_argument("--env_name", default='NS_Wind', help="Environment to run the code")
        parser.add_argument("--env_name", default='NS_Target', help="Environment to run the code")

        parser.add_argument("--max_episodes", default=int(80000), help="maximum number of episodes (75000)", type=int)
        parser.add_argument("--max_steps", default=500, help="maximum steps per episode (500)", type=int)

    def NS(self, parser):
        parser.add_argument("--buffer_size", default=int(1000), help="Size of memory buffer (3e5)", type=int)
        ...
        parser.add_argument("--fourier_k", default=3, help="Terms in extrapolator fourier basis", type=int)
        ...
        parser.add_argument("--entropy_lambda", default=10, help="Lagrangian for policy's entropy", type=float)
    ...
    def Main_AC_args(self, parser):
        ...
        parser.add_argument("--NN_basis_dim", default='16', help="Shared Dimensions for Neural network layers")
